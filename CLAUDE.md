...
- `npm run release:gate` passes in mock mode and is the default no-cost structural validation lane. The current no-cost mock gate is `output/release-gate/2026-05-18T00-41-08-849Z-35043`, with public summary at `docs/evidence/2026-05-18-mock-gate-summary.json`.
...
- Public hosted proof summaries are checked in under `docs/evidence/2026-05-17-hosted-gemini-release-summary.json`, `docs/evidence/2026-05-17-hosted-gemini-eval-summary.json`, and `docs/evidence/2026-05-17-hosted-gemini-failure-summary.json`.
...
- The repo has 13 model-routed prompt classes, a real web UI with 12 teacher-facing panels, 12 workflow tools, 53 exact API endpoints, 134 eval cases, and broad unit coverage across schema validation, prompt builders, orchestrator routes, memory retrieval, inference backends, and the web API client.
