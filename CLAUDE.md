...
- The repo has 13 model-routed prompt classes, a real web UI with 12 teacher-facing panels, 127 eval cases, and broad unit coverage (1,474 vitest + 67 pytest) across schema validation, prompt builders, orchestrator routes, memory retrieval, inference backends, and the web API client.
