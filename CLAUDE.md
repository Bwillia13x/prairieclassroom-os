...
- The repo has 13 model-routed prompt classes, a real web UI with 12 teacher-facing panels, 134 eval cases, and broad unit coverage (2,054 vitest + 69 pytest in the latest mock gate) across schema validation, prompt builders, orchestrator routes, memory retrieval, inference backends, and the web API client.
