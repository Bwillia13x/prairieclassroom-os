...
- **Verified:** the 2026-05-17 post-guardrail public demo QA in `qa/final-release/2026-05-17-post-guardrail-public-demo-qa/` reran the focused live Vercel root/canonical checks after commit `650e7e7`. It confirms the README/cellular-smoke guardrail update did not drift the public demo proof: root CTA, canonical Today, static Differentiate generation, optimized desktop/mobile WebP hero loading, empty browser logs, and zero layout failures still pass.
- **Verified:** the 2026-05-17 post-lint-fix public demo QA in `qa/final-release/2026-05-17-post-lint-fix-public-demo-qa/` reran the same focused live Vercel root/canonical checks after the public-demo QA script lint fix. It confirms root CTA, canonical Today, static Differentiate generation, optimized desktop/mobile WebP hero loading, empty browser logs, and zero layout failures still pass.
- **Verified:** the 2026-05-17 post-lint-fix broad public sweeps in `qa/final-release/2026-05-17-post-lint-fix-route-sweep/`, `qa/final-release/2026-05-17-post-lint-fix-workflow-sweep/`, and `qa/final-release/2026-05-17-post-lint-fix-accessibility-keyboard-sweep/` passed after commit `7ccc509`. They cover 13 desktop + 4 mobile public routes, 9 generated-output workflow paths, and 14 desktop/mobile accessibility-keyboard surfaces with empty failure lists and empty console/page/request/bad-response logs.
