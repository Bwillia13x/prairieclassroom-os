...
- **Eval cases covering this class:**
  ...
  - 18 `msg-lang-*` cases across Arabic, French, Punjabi, Tagalog, Ukrainian covering concern / praise / routine tones (status: `msg-lang-pa-praise` passed in the latest completed May 8 hosted eval summary; broader multilingual matrix remains authored for a wider hosted sweep).
