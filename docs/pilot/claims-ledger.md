...
| Hosted Gemini release gate passes on synthetic/demo data ← superseded by 2026-04-22 row | supported | `docs/eval-baseline.md`, `output/release-gate/2026-04-18T16-04-28-504Z-87799/` | 2026-04-18 |
| Hosted Gemini release gate passes on synthetic/demo data ← superseded by 2026-04-25 row | supported | `docs/eval-baseline.md`, pruned gate artifact (2026-04-22), `output/evals/2026-04-22-gemini/` | 2026-04-22 |
| Hosted Gemini release gate passes on synthetic/demo data | supported | `docs/eval-baseline.md`, `output/release-gate/2026-04-27T01-26-45-190Z-87424/`, `output/evals/2026-04-27-gemini/2026-04-27T01-26-45-190Z-87424-gemini-summary.json` | 2026-04-27 |
...
| Provides a one-command pilot reset (`npm run pilot:reset`) that purges and re-seeds the demo classroom to a known state with an audit tombstone ← superseded by 2026-04-23 row | supported | `scripts/pilot-reset.mjs`; refuses non-demo classroom ids by default; writes tombstone artifact to `output/pilot/`; verified end-to-end against `data/demo/seed.ts` on 2026-04-17 (42 interventions, 3 plans, 1 pattern report, 1 approved family message) | 2026-04-17 |
| Provides a one-command pilot reset (`npm run pilot:reset`) that purges and re-seeds the demo classroom to a known, teacher-believable synthetic state with an audit tombstone | supported | `scripts/pilot-reset.mjs`; `scripts/validate-demo-fixture.mjs`; `npm run demo:fixture:check`; `npm run release:gate` includes the demo fixture check before service startup. Verified clean-seed contract on 2026-04-23: 26 students, 36 interventions, 3 plans, 1 pattern report, 1 approved family message, 5 sessions, and no seeded feedback/forecast/scaffold/survival/variant/run rows. | 2026-04-23 |
...
| "Produces family messages in Alberta-regional languages" | partially supported | 18 `msg-lang-*` eval cases exist covering Punjabi, Tagalog, Mandarin, French, Arabic, Ukrainian. The latest hosted-Gemini proof suite passed `msg-lang-pa-praise`; the broader 18-case multilingual matrix remains prepared for a wider hosted sweep, so the safe claim is "one Punjabi hosted proof case plus broader authored coverage," not full multilingual validation. | 2026-04-27 |
