...
- Mock structural gate: passing at `output/release-gate/2026-05-17T07-36-39-463Z-48441`
...
- Local pre-submit gate: `npm run submission:final-check -- --skip-publication-check --skip-release-gate` passed 6/6 on 2026-05-17, and the stricter app-only final gate `npm run submission:final-check -- --skip-publication-check` passed 7/7 after the fresh mock release gate at `output/release-gate/2026-05-17T07-36-39-463Z-48441`; the final mock gate was rerun with protected-classroom browser smoke enabled so wrong-code rejection, valid-code recovery, and saved-code refresh behavior were covered.
