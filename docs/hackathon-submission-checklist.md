...
- Mock structural gate: passing at `output/release-gate/2026-05-17T14-11-36-166Z-99074`
...
- Kaggle writeup: final copy aligned to hosted proof lane, public static-first demo boundary, Alberta classroom-complexity framing, four daily jobs + closed-loop framing, and claim-safe synthetic-demo time-back-to-teaching language; current word count 1,189 (within the 1,500-word limit).
