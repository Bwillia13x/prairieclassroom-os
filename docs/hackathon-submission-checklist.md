...
- Mock structural gate: passing at `output/release-gate/2026-05-17T08-45-47-131Z-2585`
...
- Local pre-submit gate: `npm run submission:final-check -- --skip-publication-check --skip-release-gate` passed 6/6 on 2026-05-17, and the stricter app-only final gate `npm run submission:final-check -- --skip-publication-check` passed 7/7 after the fresh mock release gate at `output/release-gate/2026-05-17T08-45-47-131Z-2585`; protected-classroom prompt, wrong-code rejection, valid-code recovery, and saved-code refresh behavior remain covered by the continued browser QA bundle at `qa/final-release/2026-05-17-continued-bug-sweep/`.
- Publication gate: `npm run submission:final-check -- --skip-release-gate` now passes 7/8, including public `smoke:public-demo`, and still fails only on publication placeholders and required URL validation until the public YouTube URL and Kaggle writeup URL are filled in.
